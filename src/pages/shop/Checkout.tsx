 ...
 * 
 * Multi-step checkout process for the shop.
 * Steps:
 * 1. Contact Information (Guest/Login).
 * 2. Delivery Method (Ship/Pickup).
 * 3. Address Input (Shipping/Billing).
 * 4. Payment Options.
 * 
 * Includes an order summary sidebar.
 */
