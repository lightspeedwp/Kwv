 ...
 * 
 * Placeholder page for sections of the shop not yet live.
 * Features a large hero message and navigation back to home.
 */
    ...
    <Layout>
      <div className="min-h-[70vh] flex items-center justify-center bg-white">
        <Container variant="content" className="text-center py-20">
            <Typography variant="h1" className="font-serif text-5xl md:text-7xl text-[var(--twb-color-ink)] mb-8 leading-tight">
              Great things are <br/>on the horizon
            </Typography>
            
            <div className="w-24 h-1 bg-[var(--twb-color-gold)] mx-auto mb-10"></div>
