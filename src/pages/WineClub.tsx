...
const IMAGES = {
  ...
  pinotageBox: "https://images.unsplash.com/photo-1584916201218-f4242ceb4809?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800", // Placeholder for the Pinotage
...
export const WineClub: React.FC = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <div className="relative h-[85vh] min-h-[600px] flex flex-col justify-center items-center text-center bg-[#1a1a1a]">
        ...
        <ScrollDownArrow targetId="intro-section" />
      </div>
