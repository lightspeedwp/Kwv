 ...
 * 
 * Features:
 * - All site pages organized by category (8 sections, 58+ links)
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[var(--twb-spacing-grid-gap)]">
            {sitemapSections.map((section) => (
              <div
                key={section.title}
                className="relative bg-[var(--twb-color-bg-primary)] rounded-[var(--twb-radius-card)] p-[var(--twb-spacing-6)] shadow-[var(--twb-shadow-md)] hover:shadow-[var(--twb-shadow-lg)] transition-shadow"
              >
                {/* Organic Border */}
