 ...
 * 
 * Displays KWV's wine and spirits awards.
 * Features:
 * - Tabbed switching between "Wine Awards" and "Spirits Awards".
 * - Desktop: Sortable/filterable table view.
 * - Mobile: Card-based view.
 * - Advanced filtering dropdowns (Year, Brand, Variety, etc.).
 */
