 ...
 * 
 * Primary contact page for KWV.
 * Features:
 * - Contact form with success state.
 * - General contact details (Head Office, Johannesburg, CSR).
 * - "Tours and Tastings" specific contact info.
 * - "Member Shops" listing.
 */
export const Contact = () => {
  ...
  return (
    <Layout>
      <Hero 
        title="Contact Us"
        subtitle="We exist for consumers. Reach us here."
        imageSrc={imageHero}
        height="medium"
        nextSectionId="contact-content"
        primaryAction={{ label: 'Book a Visit', onClick: () => navigate('/experiences') }}
        secondaryAction={{ label: 'Careers', onClick: () => navigate('/careers') }}
      />

      <section id="contact-content" className="py-16 bg-white">
        <Container variant="site">
          
          {/* Main Contact Section: General Info + Form */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
            
            {/* Left Column: General Contact Information */}
            <div className="space-y-10 text-[#2C1810]">
              <Typography variant="h3" className="font-serif text-3xl font-bold border-b border-gray-200 pb-4">General</Typography>
              
              <div className="space-y-6">
                <div>
                  <h4 className="font-bold text-xl mb-3 text-[#2C1810]">KWV Head Office</h4>
                  <p className="text-gray-700 leading-relaxed mb-2">La Concorde, 57 Main Rd Paarl</p>
                  <div className="space-y-1 text-gray-700">
                    <p><span className="font-semibold w-16 inline-block text-[#2C1810]">Tel:</span> +27 21 807 3911</p>
                    <p><span className="font-semibold w-16 inline-block text-[#2C1810]">Email:</span> receptionprl@kwv.co.za</p>
                    <p><span className="font-semibold w-16 inline-block text-[#2C1810]">Email:</span> customer@kwv.co.za</p>
                    <p><span className="font-semibold w-16 inline-block text-[#2C1810]">GPS:</span> 33°75’67.6”S 18°96’21.4”E</p>
                  </div>
                </div>

                <div>
                  <h4 className="font-bold text-xl mb-3 text-[#2C1810]">KWV Johannesburg Office</h4>
                  <p className="text-gray-700 leading-relaxed mb-2">Woodmead Office Park, 12 Saddle Drive,<br/>Woodmead, Johannesburg, 2191</p>
                  <p className="text-gray-700"><span className="font-semibold w-16 inline-block text-[#2C1810]">Tel:</span> +27 11 656 0424</p>
                </div>

                <div>
                  <h4 className="font-bold text-xl mb-3 text-[#2C1810]">Corporate Social Responsibility</h4>
                  <div className="space-y-1 text-gray-700">
                    <p><span className="font-semibold w-16 inline-block text-[#2C1810]">Tel:</span> +27 21 807 3273</p>
                    <p><span className="font-semibold w-16 inline-block text-[#2C1810]">Email:</span> csi@kwv.co.za</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2C1810] text-white p-10 lg:p-16 space-y-12">
              ...
              <div>
                ...
                <div className="flex gap-4 text-[#DAA520]">
                  <a href="https://facebook.com/KWVwines" aria-label="Facebook" className="hover:text-white transition-colors"><Facebook /></a>
                  <a href="https://instagram.com/kwvwines" aria-label="Instagram" className="hover:text-white transition-colors"><Instagram /></a>
                  <a href="https://twitter.com/KWVwines" aria-label="Twitter" className="hover:text-white transition-colors"><Twitter /></a>
                </div>
              </div>
            </div>
