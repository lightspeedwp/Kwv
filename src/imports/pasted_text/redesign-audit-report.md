# Kwv hand-drawn redesign system audit and prompt-suite polish
...
- Global search results contain hardcoded KWV content and hardcoded colours (`text-gray-*`, `#8B0000`) that may fail theme and contrast expectations in dark mode. fileciteturn78file0  
