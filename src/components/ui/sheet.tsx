...
function SheetTrigger(
  ...
  if (cleanProps.asChild && React.isValidElement(cleanProps.children)) {
    ...
    return (
      <SheetPrimitive.Trigger data-slot="sheet-trigger" {...cleanProps}>
        {cleanedChild}
      </SheetPrimitive.Trigger>
    );
  }
  
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...cleanProps} />;
}
...
function SheetClose(
  ...
  if (cleanProps.asChild && React.isValidElement(cleanProps.children)) {
    ...
    return (
      <SheetPrimitive.Close data-slot="sheet-close" {...cleanProps}>
        {cleanedChild}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-[var(--twb-color-bg-inverse)]/50",
        className,
      )}
      {...cleanProps}
    />
