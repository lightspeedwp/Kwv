  ...
  return (
    <div className="flex gap-4 md:gap-6">
      ...
      <div className="flex flex-col items-start flex-shrink-0 pt-0 w-8 md:w-10">
        <Typography variant="h3" className="text-3xl font-normal text-[var(--twb-color-text-primary)] leading-none mt-1">{number}.</Typography>
      ...
      <div className="flex-1 pb-10">
        <div className="flex justify-between items-start mb-6">
          <Typography variant="h3" className="text-3xl font-normal text-[var(--twb-color-text-primary)] leading-none mt-1">{title}</Typography>
          {headerRight}
        </div>
        <div>
          {children}
